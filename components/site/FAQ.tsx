...
const faqs = [
  { q: "Does FlexiChoice charge for advisory?", a: "No. Our consultation is completely free. We earn a referral fee from partner banks and insurers — never from you." },
    ...
    <section id="faq" className="py-20 md:py-28" aria-label="Frequently asked questions">
      <div className="mx-auto max-w-3xl px-4">
        <div className="text-center">
          <p className="text-xs font-medium uppercase tracking-wider text-secondary">FAQ</p>
          <h2 className="mt-2 text-balance text-3xl font-semibold tracking-tight md:text-4xl leading-[1.1]">
            ...
            <span className="italic font-serif text-blue-600 dark:text-blue-500">answered.</span>
          </h2>
        </div>
